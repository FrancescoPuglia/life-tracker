export const firebaseConfig = {
  ...
  messagingSenderId: process.env.NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID || "970402762590",
  appId: process.env.NEXT_PUBLIC_FIREBASE_APP_ID || "1:970402762590:web:e5bc0162003ac224c449cf",
  measurementId: process.env.NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID || "G-9JKPQL8CG4",
};